    ...
    <footer className="border-t border-[#14B8A6]/10 mt-16 bg-[#080C14]">
      <div className="max-w-[1280px] mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span style={{fontFamily:'Sora, sans-serif', fontWeight:800}} className="text-white text-base">HipaaRed <span className="text-[#14B8A6]">AI</span></span>
            </div>
            <p className="text-[#E9EEF5]/40 text-xs leading-relaxed">
          ...
          {/* Legal */}
          <div>
            <h4 className="text-white text-sm font-semibold mb-4" style={{fontFamily:'Sora'}}>Legal</h4>
            <ul className="space-y-2.5">
              {['Privacy Policy', 'Terms of Service', 'BAA Template', 'Cookie Policy'].map(item => (
                <li key={item}>
                  <Link href="#" className="text-[#E9EEF5]/50 text-sm hover:text-[#14B8A6] transition-colors" style={{fontFamily:'Sora'}}>{item}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-white text-sm font-semibold mb-4" style={{fontFamily:'Sora'}}>Contact</h4>
            <ul className="space-y-2.5">
              {[
                ...
                <li key={item.label}>
                  <Link href={item.href} className="text-[#E9EEF5]/50 text-sm hover:text-[#14B8A6] transition-colors" style={{fontFamily:'Sora'}}>{item.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Socials */}
          <div>
            <h4 className="text-white text-sm font-semibold mb-4" style={{fontFamily:'Sora'}}>Follow Us</h4>
        ...
        <div className="border-t border-[#14B8A6]/10 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[#E9EEF5]/30 text-xs" style={{fontFamily:'Sora'}}>© 2025 HipaaRed AI Inc. All rights reserved.</p>
          <p className="text-[#E9EEF5]/30 text-xs" style={{fontFamily:'Sora'}}>HIPAA Compliant Infrastructure · SOC 2 Type II In Progress</p>
        </div>
      </div>
    </footer>
  )
